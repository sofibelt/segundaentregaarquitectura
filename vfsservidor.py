...
while True:
    ...
    if orden[0]=='sharelink':
        mensaje='C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\segundaentrega'+orden[1]+'.json'
        s.send_multipart([mensaje.encode()])
    if orden[0]=='list':
        list = os.listdir("C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\segundaentrega\\servidor1") # dir is your directory path
