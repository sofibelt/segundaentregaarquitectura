...
def recibir(orden):
    ...
    while True:
        ...
        if image_64_decode==b'0':
            ...
            image_result = open('C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\semana6\\servidor3\\'+orden[0]+'\\'+orden[2], 'wb')#Cambiar con respecto al usuario,escritura y binario
            image_result.write(image_64_decode)
            size_file = os.path.getsize('C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\semana6\\servidor3\\'+orden[0]+'\\'+orden[2])
...
while True:
    ...
    if orden[1]=='download' or orden[1]=='downloadlink':
        enviar(orden[0],orden[1],orden[2],'C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\semana6\\servidor3\\'+orden[0]+'\\'+orden[2])
    if orden[1]=='sharelink':
        mensaje='C:\\Users\\Sofia\\Documents\\utp\\arquitectura\\semana6\\servidor3\\'+orden[0]+'\\'+orden[2]
        s.send_multipart([mensaje.encode()])
    if orden[1]=='list':
        list = os.listdir("servidor3/"+orden[0]) # dir is your directory path
